    ...
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public bool addUser(Usuario usuario)
        {
            ...
            try
            {
                ...
                _conexionBD.setearQuery("insert	into Users (Name,LastName,Email,UserPassword,IDRol, IdSex) values(@name, @lastName, @email, @password, @Idrol, @Idsex)");
                ...
                _conexionBD.setearParametro("@Idrol", usuario.Rol.Id);
                _conexionBD.setearParametro("@Idsex", usuario.Sexo.Id);
